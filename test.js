...
const Calendar = () => {
  const viewCalendar = {
    selectedDate: '2021-04-19',
    period: 'week',
  };

  // transforme une date en string en une date utilisable par date-fns
  const selectedDate = addDays(parseISO(viewCalendar.selectedDate), 0);
